...
우측 상단의 `Private` 토글을 선택하면 Public 카드가 전환 애니메이션과 함께 사라지고, 아래 11개 private 메뉴 카드가 표시됩니다.
...
| `B` | Best Article Explorer | `https://best-article-explorer.ai.studio` | `newspaper` |
